...
declare function errors:get-status-code-from-error($error as xs:QName) as xs:integer {
    switch ($error)
        ...
        case $errors:BODY_CONTENT_TYPE return
            400
        ...
        case $errors:NOT_FOUND return
            404
        case $errors:METHOD_NOT_ALLOWED return
            405
        case $errors:CONFLICT return
            409
        case $errors:UNSUPPORTED_MEDIA_TYPE return
            415
        case $errors:UNPROCESSABLE_ENTITY return
            422
        case $errors:OPERATION (: fall-through :)
        case $errors:SERVER_ERROR return
            500 (: no fall-through possible :)
        case $errors:NOT_IMPLEMENTED return
            501 (: no fall-through possible :)
        default return
            500
};
