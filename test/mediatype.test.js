...
describe('body with content-type application/xml', function () {
    ...
    describe('with valid content', function () {
        ...
        before(function () {
            return util.axios
                .post('api/paths/' + filename, contents, {
        ...
        it('can be retrieved', async function () {
            const { status, data } = await util.axios.get(downloadApiEndpoint + filename, {
...
<örtchen name="München" />`,
    ...
    describe('with invalid content', function () {
        ...
        before(async function () {
            return util.axios
                .post('api/paths/invalid.xml', Buffer.from('<invalid>asdf'), {
                    headers: { 'Content-Type': 'application/xml' }
                })
                .then((r) => (uploadResponse = r))
        ...
        it('with a human readable description', function () {
            expect(uploadResponse.data.description).to.equal(
                "Body with media type 'application/xml' could not be parsed (invalid XML)."
            )
        })
    })
})
...
describe('body with content-type application/tei+xml', function () {
    ...
    describe('with invalid content', function () {
        ...
        before(async function () {
            return util.axios
                .post('api/paths/invalid.tei.xml', Buffer.from('<TEI>asdf'), {
                    headers: { 'Content-Type': 'application/tei+xml' }
                })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        ...
        it('with a human readable description', function () {
            expect(uploadResponse.data.description).to.equal(
                "Body with media type 'application/tei+xml' could not be parsed (invalid XML)."
            )
        })
    })
})
...
describe('body with content-type application/json', function () {
    ...
    describe('with valid content', function () {
        ...
        before(function () {
            return util.axios
                .post('api/paths/' + filename, contents, { headers: { 'Content-Type': 'application/json' } })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
        it('is uploaded', function () {
    ...
    describe('with invalid content', function () {
        ...
        before(function () {
            return util.axios
                .post('api/paths/invalid.json', '{"invalid: ()}', {
        ...
        it('with a human readable description', function () {
            expect(uploadResponse.data.description).to.equal(
                "Body with media type 'application/json' could not be parsed (invalid JSON)."
            )
        })
    })
})
...
describe('body with content-type application/json-patch+json', function () {
    ...
    describe('with valid content', function () {
        ...
        before(function () {
            return util.axios
                .post('api/paths/' + filename, contents, { headers: { 'Content-Type': 'application/json-patch+json' } })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
        it('is uploaded', function () {
    ...
    describe('with invalid content', function () {
        ...
        before(function () {
            return util.axios
                .post('api/paths/invalid-path.json', '[{"op":"test","value":"foo","', {
        ...
        it('with a human readable description', function () {
            expect(uploadResponse.data.description).to.equal(
                "Body with media type 'application/json-patch+json' could not be parsed (invalid JSON)."
            )
        })
    })
})
...
`)
        ...
        before(function () {
            return util.axios
                .post('upload/single/' + filename, data, { headers })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
        it('is uploaded', function () {
    ...
    describe('with no data', function () {
        ...
        before(function () {
            return util.axios
                .post('upload/single/nothing', data, { headers })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
    ...
    describe('with two files when only one is allowed', function () {
        ...
        before(function () {
            return util.axios
                .post('upload/single/abcd', data, { headers })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
    ...
    describe('with two files', function () {
        ...
        before(function () {
            return util.axios
                .post('upload/batch', data, { headers })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
    ...
    describe('text sent base64 encoded', function () {
        ...
        before(function () {
            return util.axios
                .post('upload/base64', data, { headers })
                .then((r) => (uploadResponse = r))
                .catch((e) => (uploadResponse = e.response))
        })
...
describe('with invalid content-type header', function () {
    ...
    before(function () {
        return util.axios
            .post('api/paths/invalid.stuff', 'asd;lfkjdas;flkja', {
                headers: {
